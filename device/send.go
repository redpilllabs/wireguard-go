...
func (peer *Peer) SendKeepalive() {
	if len(peer.queue.staged) == 0 && peer.isRunning.Load() {
		...
		// peer.device.log.Verbosef("%v - Unblocking a keepalive to warp endpoint: %v", peer, peer.endpoint.val.DstToString())
		// peer.sendRandomPackets(30, 100, 0, 1)
		// }
...
func (peer *Peer) SendHandshakeInitiation(isRetry bool) error {
	...
	peer.sendRandomPackets(30, 100, 0, 10)
